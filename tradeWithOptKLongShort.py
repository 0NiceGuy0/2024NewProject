...
class AutoTrader:
    ...
    def trade_logic(self):
        ...
        if self.long_target is not None and self.short_target is not None:
            if not self.is_holding and current_price > self.long_target:
            ...
            elif self.is_holding and (current_price < self.short_target or self.check_stop_loss(current_price)):
